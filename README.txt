...
In my experiments, running:
$ python binder.py /bin/ls /bin/pwd
followed by:
$ ./bound
I encountered the following: 
README.txt		binderbackend.cpp	codearray.h		samples
binder.py		bound			main.cpp		simple.cpp
README.txt		binderbackend.cpp	codearray.h		samples
binder.py		bound			main.cpp		simple.cpp

In essence, the bound file executed the /bin/ls program twice. Similarly, if I reverse the two binaries and run:
$ python binder.py /bin/pwd /bin/ls
I get the following:
/Volumes/Macintosh HD/Users/austinwhite/Dropbox/CSUF/Fall2014/CPSC 456/node/assignment2
/Volumes/Macintosh HD/Users/austinwhite/Dropbox/CSUF/Fall2014/CPSC 456/node/assignment2

The current working directory, twice. Finally, if I add a third program, I get:
$ python binder.py /usr/bin/whoami /bin/pwd /bin/ls
...
Or, the /usr/bin/whoami program executed three times.
